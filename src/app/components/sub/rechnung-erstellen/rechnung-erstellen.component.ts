...
export class RechnungErstellenComponent implements OnInit, OnDestroy {
  ...
  address: Address = {
    ...
    vorname: '',
    nachname: '',
    unternehmen: this.formatCustomer(this.task.unternehmen),
    strasse: this.getAddress(this.task).strasse,
    plz: this.getAddress(this.task).plz,
    ort: this.getAddress(this.task).ort,
    anmerkungen: '',
